      ...
      <div className="grid gap-6 lg:grid-cols-[1fr_360px]">
        <div className="space-y-8">
          ...
          <section className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="hud-card p-4 space-y-4 lg:col-span-1">
        ...
        {/* 右サイドバー: AIコーチ常設 */}
        <aside className="hidden lg:block hud-card p-0 min-h-0 overflow-hidden">
          <div className="p-3 border-b border-neon/20 text-neon">AI Coach</div>
          <div className="h-[calc(100%-2.5rem)]">
            <ChatPanel open embedded onClose={() => {}} onStreamingChange={(streaming) => setAvatarState(streaming ? 'talk' : 'idle')} />
          </div>
        </aside>
      </div>
    </main>
